...
// terminal paste
#define KC_TPSTE  LSFT(KC_INSERT)
 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  ~   |  '"  |  L2  | Left | Right|                                       | Down |  Up  |   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        |Hyper | Lalt |       | Ralt | Hyper  |
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Home |       | PgUp |        |      |
 *                                 | Space| Ret  |------|       |------|  Ret   |Space |
 *                                 |      |      | End  |       | PgDn |        |      |
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        // left hand
        KC_EQL,         KC_1,         KC_2,   KC_3,   KC_4,   KC_5,   KC_TPSTE,
        KC_TAB,         KC_Q,         KC_W,   KC_E,   KC_R,   KC_T,   GUI_T(KC_BSPC),
        CTL_T(KC_ESC),  KC_A,         KC_S,   KC_D,   KC_F,   KC_G,
        KC_LSFT,        KC_Z,         KC_X,   KC_C,   KC_V,   KC_B,   LT(SYMB, KC_TAB),
        KC_GRV,         KC_QUOT,   TG(MDIA), KC_LEFT, KC_RGHT,

                                                                  KC_HYPR,  KC_LALT,
                                                                            KC_HOME,
                                                           KC_SPC, KC_ENT,  KC_END,
        // right hand
         KC_TPSTE,   KC_6,   KC_7,    KC_8,    KC_9,   KC_0,             KC_MINS,
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS,   KC_HASH, KC_AMPR, KC_PIPE, KC_BSLS, KC_TRNS,   KC_TRNS,
       KC_TRNS,   KC_TILD, KC_UNDS, KC_EQL,  KC_SLSH, KC_TRNS,
       KC_TRNS,   KC_QSTN, KC_DLR,  KC_AT,   KC_PERC, KC_TRNS,   KC_TRNS,
       ...
       KC_TRNS,   RESET,   KC_LBRC, KC_LANG, KC_RANG, KC_RBRC,   KC_TRNS,
